...
// Help
$_['help_url']                         = 'Включите полный URL вашего магазина. Не забудьте добавить \'/\' в конце. Пример: http://www.yourdomain. om/path/<br><br>Не используйте каталоги для создания нового магазина. Вы всегда должны указать другой домен или поддон на вашем хостинге.';
