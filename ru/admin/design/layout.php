...
$_['error_article']       = 'Внимание: Этот макет нельзя удалить, поскольку он в настоящее время назначен %s страницам статей!';
$_['error_topic']         = 'Внимание: Этот макет нельзя удалить, поскольку он в настоящее время назначен %s страницам тем!';
